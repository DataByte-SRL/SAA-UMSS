...
var overlay_form = document.querySelector(".overlay-nueva-aula");
var form = document.querySelector(".formulario-nueva-aula");
...
function ponerFuncionBotones(){
    ...
    overlay_form.addEventListener("click",(e)=>{
        if(e.target.classList.contains("overlay-nueva-aula")){
                 overlay_form.classList.remove("formulario-activo");
                form.classList.remove("formulario-activo"); 
