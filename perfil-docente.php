    ...
    <div class="formulario-perfil">
      ...
      <div class="seccion-datos">
        ...
        <div class="seccion-input">
          ...
          <input type="text" class="input-casilla" name="facultad" value="<?php echo $separar['nombre'];?>" >
        </div>  
        ...
        <div class="seccion-input">
          ...
          <input type="email" class="input-casilla" name="correo" value="<?php echo $extraer['correo'];?>">
                ...
                <div class="seccion-botones-form-a">
                    <tr>
                        <input type="button" class="btn-aceptar" name="Actualizar" value="Actualizar" onClick="location.href='../php/actualizar-docente.php'">
                    </tr>
					<br></br>
                    <tr>
