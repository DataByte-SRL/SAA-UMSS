...
if ($_POST) {   
    ...
    foreach ($solicitantes as $key => $value) {
        ...
        $respuesta  = mysqli_query($con ,"SELECT  G.codGrupo as codigoGrupo ,CONCAT(D.nombre,' ',D.apellido) as docente, G.estudiantes as cantidad ,G.codDocente  FROM Grupo G, Docente D WHERE G.codDocente = D.codigoSis AND G.codDocente = $codSis AND G.codMateria = $codMateria");
